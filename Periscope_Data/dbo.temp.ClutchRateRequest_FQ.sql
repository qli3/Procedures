...
/****** Object:  StoredProcedure [dbo].[temp.ClutchRateRequest_FQ]    Script Date: 12/15/2017 4:41:20 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[temp.ClutchRateRequest_FQ]
AS
...
BEGIN
	...
	IF OBJECT_ID('Periscope_Data.dbo.Temp_ClutchRateRequest_FQ', 'U') IS NOT NULL
		DROP TABLE Periscope_Data.dbo.Temp_ClutchRateRequest_FQ;
...
INTO Periscope_Data.dbo.Temp_ClutchRateRequest_FQ
								FROM #T c
