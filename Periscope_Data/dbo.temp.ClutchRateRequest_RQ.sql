...
/****** Object:  StoredProcedure [dbo].[temp.ClutchRateRequest_RQ]    Script Date: 12/15/2017 4:41:35 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[temp.ClutchRateRequest_RQ]
AS
...
BEGIN
	...
	IF OBJECT_ID('Periscope_Data.dbo.Temp_ClutchRateRequest_RQ', 'U') IS NOT NULL
		DROP TABLE Periscope_Data.dbo.Temp_ClutchRateRequest_RQ;
...
INTO Periscope_Data.dbo.Temp_ClutchRateRequest_RQ
								FROM #T c
